    ...
    <form id="form1" runat="server">
        ...
        <div style="text-align: center; font-size: large">
            <table class="Center">
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="Label3" runat="server" Text="Contraseña"></asp:Label></td>
                    <td class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">
                        ...
                        <br />
                        <br />
                        <asp:Button ID="Button1" runat="server" Height="44px" OnClick="Button1_Click" Text="Login" Width="98px" /></td>
                    <td class="auto-style1">
                        <br />
                        <asp:Label ID="ERROR" runat="server"></asp:Label>
                        <br />
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="Register.aspx">Registrarme</asp:HyperLink><br />
